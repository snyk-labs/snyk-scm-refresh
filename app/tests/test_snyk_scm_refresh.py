...
@pytest.mark.parametrize('status_code, response_message, repo, name, owner', [(200, 'Match', 'test_org/test_repo', 'test_repo', 'test_owner'), (301, 'Moved new_repo', 'new_owner/new_repo', 'new_repo', 'new_owner'), (404, 'Not Found', 'test_org/test_repo', None, None)])
def test_get_gh_repo_status(mocker, status_code, response_message, repo, name, owner):
    ...
    mocker.patch('requests.get', side_effect=[MockResponse(status_code), MockResponse(200)])
